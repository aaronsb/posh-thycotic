function Choose-ADOrganizationalUnit
{
    ...
    function Call-AD_OU_select_pff {
	    ...
	    $buttonNewOU = New-Object 'System.Windows.Forms.Button'
	    ...
	    $buttonNewOU_Click={
		    ...
		    IF ($IsAdmin -eq $true){
		        ...
		        $SelectedOU.Nodes.Add($newOuNode) | Out-Null 
		        If($SelectedOU.IsExpanded -ne $true){
		            $SelectedOU.Expand()
		        }
			    ...
			    $ErrorProviderOU.SetError($buttonNewOU, 'This option requires elevation')
		    }
	    }
	
	    $CreateOU=[System.Windows.Forms.NodeLabelEditEventHandler]{
	    #Event Argument: $_ = [System.Windows.Forms.NodeLabelEditEventArgs]
		    $newOuNode.Name = "OU=" + $_.Label + "," + $newOuNode.Parent.Name
		    $treeview1.SelectedNode = $newOuNode
	        # Using dsadd command instead of New-ADOrganizationalUnit because of 
	        # "Access denied" error. This will require elevation.
		    $cmd_AddOU = 'dsadd ou "' + $newOuNode.Name + '"'
		    Invoke-Expression $cmd_AddOU
		    Get-ADobject -Filter * -SearchBase $newOuNode.Name | Set-adobject -ProtectedFromAccidentalDeletion $true
	    ...
	    $Form_Cleanup_FormClosed=
	    {
		    ...
		    try
		    {
			    $buttonNewOU.remove_Click($buttonNewOU_Click)
	    ...
	    # formChooseOU
	    #
	    $formChooseOU.Controls.Add($buttonNewOU)
    ...
    AADAAwAAwAMAAMADAADAAwAAwAMAAP//AAA=')
	    ...
	    # buttonNewOU
	    #
	    $buttonNewOU.Location = '19, 467'
	    $buttonNewOU.Name = "buttonNewOU"
	    $buttonNewOU.Size = '75, 23'
	    $buttonNewOU.TabIndex = 2
	    $buttonNewOU.Text = "New OU"
	    $buttonNewOU.UseVisualStyleBackColor = $True
	    $buttonNewOU.add_Click($buttonNewOU_Click)
	    #
	    # treeview1
	    #
